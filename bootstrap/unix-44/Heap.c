/* voc 2.00 [2016/12/05]. Bootstrapping compiler for address size 8, alignment 8. tsSF */
...
void Heap_InitHeap (void)
{
	...
	Heap_allocated = 0;
	Heap_lockdepth = 0;
	Heap_heapPosMin = 2147483647;
	Heap_heapPosMax = 0;
	Heap_heapNegMin = 0;
	Heap_heapNegMax = (-2147483647-1);
